...
public partial class Funcionarios_Relatorios_PDF_6 : System.Web.UI.Page
{
    ...
    private void TabelaCorpo()
    {
        ...
        {
            case "Todas":
                stringselect = "select  nome, Situacao , funcao, vinculo  " +
