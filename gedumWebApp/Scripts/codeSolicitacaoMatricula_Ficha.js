function SalvarRegistro() {
    ...
    strLine = strLine + "param" + i + ":'" + document.getElementById("IDAuxHidden").value + "'";

    UIAguardar();

    $.ajax({
        type: "POST",
        url: "WebService.asmx/SolicitacoesMatriculas_Alterar",
        data: '{' + strLine + '}',
...
function voltar() {
    var url = "SolicitacoesMatriculas_Listagem.aspx";
