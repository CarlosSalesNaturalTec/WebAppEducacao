...
public partial class Modelos_Listagem : System.Web.UI.Page
{
    ...
    private void dadosCorpo()
    {
        ...
        while (dados.Read())
        {
            ...
            // <!--*******Customização*******-->
            string bt1 = "<a class='w3-btn w3-round w3-hover-blue w3-text-green' href='Modelos_Ficha.aspx?v1=" + Coluna0 + "'><i class='fa fa-id-card-o' aria-hidden='true'></i></a>";
