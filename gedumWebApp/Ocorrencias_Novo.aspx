<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ocorrencias_Novo.aspx.cs" Inherits="Ocorrencias_Novo" %>
...
<body>
    ...
    <div style="margin-left: 180px">
        ...
        <!-- GRUPO 1 - Dados Ocorrências -->
        <div id="grupo1" class="w3-container grupo w3-animate-left" style="display: block">

            
            <h3><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp;Dados Gerais - Nova Ocorrência</h3>
            <hr />
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select id="input_funcionario" class="form-control" >
                                    <asp:Literal ID="Literal_Funcionario" runat="server"></asp:Literal>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="input_data_ocorrencia" class="col-md-2 control-label">Data Ocorrência</label>
                            <div class="col-md-3">
                                <input type="date" class="form-control" id="input_data_ocorrencia"/>
                            </div>

                            <label for="input_tipo_ocorrencia" class="col-md-2 control-label">Tipo Ocorrência</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="input_tipo_ocorrencia"/>
                            </div>
                        </div>
    ...
    <!-- Scripts Diversos  -->
    <script type="text/javascript" src="Scripts/codeOcorrencias_Novo.js"></script>
