<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alunos_Ficha_Frequencia.aspx.cs" Inherits="Alunos_Ficha_Frequencia" %>
...
<head runat="server">
    ...
    <title>Ficha de Frequencia Individual</title>
            ...
            <div class="w3-threequarter">
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="input_Curso" class="col-md-2 control-label">Turma</label>
                            <div class="col-md-9">
