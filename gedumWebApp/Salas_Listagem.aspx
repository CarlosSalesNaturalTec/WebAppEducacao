<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Salas_Listagem.aspx.cs" Inherits="Salas_Listagem" %>
...
<head runat="server">
    ...
    <title>Listagem de Salas</title>         <!--*******Customização*******-->
...
<body>
    ...
    <div class="w3-container w3-border w3-round w3-padding-16 w3-light-green" style="margin-left: 2%; margin-right: 2%">
        <small><i class="fa fa-calendar-check-o fa-2x"></i>&nbsp;&nbsp;Total de Salas Cadastradas:
            <asp:Literal ID="lblTotalRegistros" runat="server"></asp:Literal></small> <!--*******Customização*******-->
        &nbsp;&nbsp;
        <button class="w3-btn w3-round w3-border w3-green w3-right" onclick="NovoRegistro()"><i class="fa fa-plus"></i>&nbsp;Nova Sala</button>  <!--*******Customização*******-->
    </div>
    ...
    <!-- Scripts Diversos -->
    <script type="text/javascript" src="Scripts/codeSalas_Listagem.js"></script>   <!--*******Customização*******-->
