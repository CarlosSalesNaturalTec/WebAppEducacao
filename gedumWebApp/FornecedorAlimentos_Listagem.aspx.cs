...
public partial class FornecedorAlimentos_Listagem : System.Web.UI.Page
{
    ...
    {
        // <!--*******Customização*******-->
        string stringselect = "select ID_FornecedorAlimento, descricao, cpf_cnpj, cidade, telefone1 " +
                "from Tbl_Fornecedor_Alimentos " +
        ...
        while (dados.Read())
        {
            ...
            string bt1 = "<a class='w3-btn w3-round w3-hover-blue w3-text-green' href='FornecedorAlimentos_Ficha.aspx?v1=" + Coluna0 + "'><i class='fa fa-id-card-o' aria-hidden='true'></i></a>";
