<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Atestados_Novo.aspx.cs" Inherits="Atestados_Novo" %>
...
<head runat="server">
    ...
    <title>Cadastro de Atestados</title>
...
<body>
    ...
    <div style="margin-left: 180px">
        ...
        <div id="grupo1" class="w3-container grupo w3-animate-left" style="display: block">
            ...
            <h3><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp;Dados Gerais - Novo Atestado</h3>
            <hr />
