...
<head runat="server">
    ...
    <title>Ficha do Funcoionário</title>  <!--*******Customização*******-->
   ...
   <!--*******MENU LATERAL - Customização*******-->
    <div class="w3-sidebar w3-bar-block w3-green w3-card-2" style="width: 180px">
        ...
        <div class="w3-center">
            ...
            <button type="button" class="w3-btn w3-round w3-border w3-light-green w3-hover-blue" onclick="AlterarRegistro()" id="btSalvar"><i class="fa fa-save"></i></button>
    ...
    <div style="margin-left: 180px">
        ...
        <div id="grupo8" class="w3-container grupo w3-animate-left" style="display: none">
            ...
            <div>
                ...
                <div class="col-md-1">
                    <button id="btConcluir" class="w3-btn w3-light-green w3-hover-green" onclick="AlterarRegistro()">CONCLUIR</button>
                </div>
            </div>
        </div>
