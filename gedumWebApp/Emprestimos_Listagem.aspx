...
<head runat="server">
    ...
    <title>Listagem de Empréstimos</title>         <!--*******Customização*******-->
...
<body>
    ...
    <div class="w3-container w3-border w3-round w3-padding-16 w3-light-green" style="margin-left: 2%; margin-right: 2%">
        ...
        &nbsp;&nbsp;
        <button class="w3-btn w3-round w3-border w3-green w3-right" onclick="NovoRegistro()"><i class="fa fa-plus"></i>&nbsp;Novo Empréstimo</button>  <!--*******Customização*******-->
    </div>
    ...
    <!-- Scripts Diversos -->
    <script type="text/javascript" src="Scripts/codeEmprestimos_Listagem.js"></script>   <!--*******Customização*******-->
