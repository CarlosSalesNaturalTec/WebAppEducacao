<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Livros_Ficha.aspx.cs" Inherits="Livros_Ficha" %>
...
<body>
    ...
    <div style="margin-left: 180px">
        ...
        <div id="grupo1" class="w3-container grupo w3-animate-left" style="display: block">
            ...
            <!--*******Customização*******-->
            <h3><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp;Dados Gerais - Ficha de Livros</h3>
            <hr />
