<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emprestimos_Ficha.aspx.cs" Inherits="Emprestimos_Ficha" %>
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <label for="input_data_dev" class="col-md-2 control-label">Devolução</label>
                            <div class="col-md-3">
                                <input type="date" class="form-control" id="input_data_dev"/>
                            </div>
                        </div>
