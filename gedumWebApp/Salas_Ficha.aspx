<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Salas_Ficha.aspx.cs" Inherits="Salas_Ficha" %>
...
<body>
    ...
    <div style="margin-left: 180px">
        ...
        <div id="grupo1" class="w3-container grupo w3-animate-left" style="display: block">
            ...
            <!--*******Customização*******-->
            <h3><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp;Dados Pessoais- Ficha Sala</h3>
            <hr />
            ...
            <div class="w3-threequarter">
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="input_adm" class="col-md-2 control-label">Sala administrativa?</label>
                            <div class="col-md-4">
                                <select class="form-control" id="input_sala_adm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="date" class="form-control" id="input_capacidademax">
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="Scripts/codeSalas_Mapa.js"></script>
