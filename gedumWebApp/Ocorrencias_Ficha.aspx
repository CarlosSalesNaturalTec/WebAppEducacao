<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ocorrencias_Ficha.aspx.cs" Inherits="Ocorrencias_Ficha" %>
...
<body>
    ...
    <div style="margin-left: 180px">
        ...
        <!-- GRUPO 1 - Dados Ocorrência -->
        <div id="grupo1" class="w3-container grupo w3-animate-left" style="display: block">

            <h3><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp;Ficha de Ocorrência</h3>
            <hr />
