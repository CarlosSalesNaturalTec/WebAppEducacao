<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alunos_Listagem.aspx.cs" Inherits="Alunos_Listagem" %>
...
<head runat="server">
    ...
    <title>Listagem de Alunos</title>         <!--*******Customização*******-->
...
<body>
    ...
    <div class="w3-container w3-border w3-round w3-padding-16 w3-light-green" style="margin-left: 2%; margin-right: 2%">
        ...
        &nbsp;&nbsp;
        <button class="w3-btn w3-round w3-border w3-green w3-right" onclick="NovoRegistro()"><i class="fa fa-plus"></i>&nbsp;Novo Aluno</button>  <!--*******Customização*******-->
    </div>
