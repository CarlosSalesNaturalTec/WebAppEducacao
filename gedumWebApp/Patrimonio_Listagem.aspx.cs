...
public partial class Patrimonio_Listagem : System.Web.UI.Page
{
    ...
    {
        // <!--*******Customização*******-->
        string stringselect = "select ID_Patrimonio, Descricao, Situacao ,Valor, Sala " +
        ...
        while (dados.Read())
        {
            ...
            // <!--*******Customização*******-->
            string bt1 = "<a class='w3-btn w3-round w3-hover-blue w3-text-green' href='Patrimonio_Ficha.aspx?v1=" + Coluna0 + "'><i class='fa fa-id-card-o' aria-hidden='true'></i></a>";
